...
function Hero() {
  return (
    <div className="poppins mt-36 md:mt-32 xl:mt-40 2xl:mt-44 grid md:grid-cols-2 grid-cols-1 gap-x-2 gap-y-8">
      <h1 className="slide-in semibold text-4xl text-violet-50">
        Transformăm{" "}
        <span className="text-violet-500">
          Viziunea Ta în Realitate Digitală
        </span>
      </h1>
      <p className="text-violet-50 slide-right">
      ...
      <div className="md:w-8/12 slide-left ">
      ...
      <div className="flex flex-col gap-4">
        ...
        <p className="text-violet-50 slide-right">
          Cu fiecare proiect pe care-l dezvoltăm, creăm o conexiune durabilă
